  ...
  const interviews = [
    {
      ...
      meetLink: "https://meet.google.com/lead-abc-def",
      type: "Leadership",
    ...
    },
    {
      ...
      time: "1:00 PM",
      status: "Completed",
      meetLink: "https://meet.google.com/lead-xyz-qrs",
      type: "Leadership",
      focus: "Strategic Planning & Vision"
    },
    {
      id: 3,
      ...
      time: "10:00 AM",
      status: "Upcoming",
      meetLink: "https://meet.google.com/lead-lmn-opq",
      type: "Leadership",
    ...
    },
    {
      ...
      time: "2:30 PM",
      status: "Upcoming",
      meetLink: "https://meet.google.com/lead-rst-uvw",
      type: "Leadership",
    ...
    <LeadershipInterviewLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Leadership Interviews</h1>
            <p className="text-muted-foreground mt-1">Evaluate strategic thinking, team management, and leadership skills</p>
          </div>
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {interview.status === "Pending Review" && (
                            <Button size="sm" asChild className="bg-orange-500 hover:bg-orange-600 gap-2">
                              <Link to={`/leadership-interviewer/interviews/${interview.id}/review`}>
